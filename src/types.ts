...
export const translations: Record<Language, TranslationDict> = {
  pt: {
    ...
    heroTitle: "Soluções Corporativas Integradas e Fornecimento de Alta Qualidade em Angola",
    heroSubtitle: "A CAHOTA LDA é uma parceira estratégica multissetorial focada na excelência integral. Gerenciamos desde infraestruturas avançadas de TI, Mobilidade Urbana p/ Aplicativos e Seguros até Engenharia de Construção Civil e Suprimentos com confiabilidade e pós-venda premium.",
    heroCTAQuote: "Solicitar Cotação Agora",
    heroCTAServices: "Conhecer Serviços",
    heroBadge: "Parceiro Multissetorial & Soluções Integradas",
    
    aboutTitle: "Apresentação Corporativa",
    aboutSubtitle: "Operando com padrões de excelência há mais de 3 anos em múltiplos setores estratégicos de Angola.",
    aboutText1: "A CAHOTA LDA é uma empresa angolana com sede em Luanda, estrategicamente localizada no Ed. W5, Centralidade do Kilamba, com representação activa nas províncias de Luanda e Benguela (Lobito). Atendemos com extremo rigor técnico e operacional às frentes públicas e privadas do mercado nacional.",
    aboutText2: "A nossa missão é prover suporte transversal através de soluções inteligentes em tecnologia, engenharia civil, mobilidade urbana regulada, gestão de seguros corporativos, medicina no trabalho e fornecimento técnico industrial. Unimos agilidade logística profunda e sustentabilidade comercial.",
    aboutYears: "3+",
    aboutYearsText: "Anos de Operação Sólida em Angola",
    aboutLocationTitle: "Presença Estratégica",
    aboutLocationText: "Luanda (Sede no Kilamba) & Representação no Lobito e principais províncias",
    
    servicesTitle: "Nossas Áreas de Atuação",
    servicesSubtitle: "Atuamos de forma integrada em 10 divisões de negócios complementares, unindo suprimentos de grande escala a serviços corporativos especializados de alta tecnologia.",
  ...
  en: {
    ...
    heroTitle: "Integrated Corporate Solutions and High-Quality Provisioning in Angola",
    heroSubtitle: "CAHOTA LDA is an all-round strategic multisector partner focused on overall excellence. We manage everything from advanced IT infrastructures, Corporate Insurance, and App-Based Ride-Hailing to Civil Construction and Technical Supplies with premium support.",
    heroCTAQuote: "Request a Quote Now",
    heroCTAServices: "Explore Services",
    heroBadge: "Multisector Partner & Integrated Solutions",
    
    aboutTitle: "Corporate Presentation",
    aboutSubtitle: "Operating with standards of excellence for over 3 years across multiple strategic sectors in Angola.",
    aboutText1: "CAHOTA LDA is an Angolan company headquartered in Luanda, strategically located at Ed. W5, Centralidade do Kilamba, with active representation in Luanda and Benguela (Lobito) provinces. We serve both public and private sectors in the national market with high operational and technical standards.",
    aboutText2: "Our mission is to provide comprehensive transversal support to our clients through intelligent solutions in technology, civil construction engineering, regulated urban mobility, corporate insurance management, occupational health, and industrial technical supplies, combining deep logistical agility and commercial stability.",
    aboutYears: "3+",
    aboutYearsText: "Years of Solid Operations in Angola",
    aboutLocationTitle: "Strategic Presence",
    aboutLocationText: "Luanda (Kilamba Headquarters) & Branch Office in Lobito, and main provinces",
    
    servicesTitle: "Our Areas of Expertise",
    servicesSubtitle: "We work seamlessly across 10 complementary business divisions, uniting large-scale sourcing with specialized corporate services of high technology.",
    service1Name: "Ship Chandling",
